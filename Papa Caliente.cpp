...
int main(){
	vector<string> jugadores = {"1.Erick", "2.Enmanuel", "3.Briam", "4.Gabriel", "5.Mar¡a", "6.Oscar", "7.Krista",
								"8.Eduardo", "9.Alejandra", "10.Carlos", "11.Diego", "12.Manuel", "13.Jàse",
...
void papaCaliente(const vector<string> &listaNombres){
	...
	for(int i=cantidadJugadores; i>1; i--){
		...
		cout<<funado<<endl<<"Alto!!! "<<funado<<" sale del juego..."<<endl<<endl;
	}
	string ganador = simulacion.dequeue();
	cout<<ganador<<" gana el juego :)"<<endl;
}
